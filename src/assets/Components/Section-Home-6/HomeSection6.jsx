...
import Client1 from "/src/assets/images/01.png";
import Client2 from "/src/assets/images/02.png";
import Client3 from "/src/assets/images/03.png";
import Client4 from "/src/assets/images/05.png";
import Client5 from "/src/assets/images/06.png";
import Client6 from "/src/assets/images/07.png";
import Client7 from "/src/assets/images/08.png";
import Client8 from "/src/assets/images/10.png";
import Client9 from "/src/assets/images/11.png";
import Rate from "/src/assets/images/stars.png";
import Capsule from "/src/assets/images/brand-01.svg";
import AltShift from "/src/assets/images/brand-03.svg";
import Polymatc from "/src/assets/images/brand-05.svg";
import BoltShift from "/src/assets/images/brand-07.svg";
    ...
    <div className="bg-[#052128] py-20 relative overflow-hidden mb-20 px-4 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="bg-[#C1FEB4] text-[#1A1A1A] px-5 py-2 rounded-full font-bold text-sm mb-6 inline-block tracking-wider uppercase">
            Clients feedback
          </span>
