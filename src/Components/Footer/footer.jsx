...
import Logo from "/src/images/logo-8-dark.svg";
...
const Footer = () => {
  ...
  const handleLanguageSelect = (language) => {
    ...
    // هنا يمكنك إضافة أي منطق إضافي لتغيير لغة الموقع
  };
  ...
  return (
    <>
      <motion.footer
        ...
        className='flex flex-col items-center bg-[#08313B] border-2 border-[#2C5058] rounded-xl p-6 md:p-16 lg:p-32 mb-10 mx-4 md:mx-8 lg:mx-16'
      >
        ...
        >
          ...
          <Rating
            ...
            sx={{ color: '#C1FEB4' }}
          />
          <span className='text-white'>5,200+ reviews on</span>
        ...
        <div className="flex flex-col md:flex-row justify-between w-full mt-12 mb-12">
            ...
            <AnimatePresence>
              {isDropdownOpen && (
                <motion.ul
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  transition={{ duration: 0.3 }}
                  className="absolute top-12 bg-[#337d8f] text-white w-32 rounded-md shadow-md z-50"
                >
                  <li 
                    className="p-2 hover:bg-[#0d4a56] cursor-pointer"
          ...
          <div className="flex text-white">
            <div className="flex flex-wrap justify-between gap-16 sm:gap-8 md:gap-16">
              ...
              {/* Column 3 - سيظهر فقط في الشاشات المتوسطة والكبيرة */}
              <div className="hidden md:flex flex-col gap-4 hover:text-gray-400 transition duration-300">
